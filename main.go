...
func isReasonixNoise(line string) bool {
	...
	if strings.HasPrefix(trimmed, "❌") || strings.HasPrefix(trimmed, "✅") || strings.HasPrefix(trimmed, "ℹ️") || strings.HasPrefix(trimmed, "hook ") || strings.Contains(trimmed, "exit status") {
		return true
	}
