		...
		case "approval_request":
			if ev.Approval != nil && ev.Approval.ID != "" {
				if onApprovalRequest != nil {
					...
					onApprovalRequest(ev.Approval.ID, toolName, ev.Approval.Scope, ev.Approval.Preview)
				}
			}
		case "usage":
